...
set_directive_pipeline -II 1 "beamformer/loop2"
set_directive_pipeline -II 1 "beamformer/readA"
set_directive_pipeline -II 1 "beamformer/readB"
set_directive_pipeline -II 1 "beamformer/writeC"
set_directive_array_partition -type complete -dim 2 "beamformer" RXi
set_directive_array_partition -type complete -dim 2 "beamformer" RXq
set_directive_array_partition -type complete -dim 2 "beamformer" Wi
set_directive_array_partition -type complete -dim 2 "beamformer" Wq
